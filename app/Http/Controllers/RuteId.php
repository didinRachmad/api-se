...
class RuteId extends Controller
{
    ...
    public function getSalesman(Request $request)
    {
        ...
        $salesman =
            MasterRute::with('w', 'kr')->select('salesman', 'id_wilayah')
    ...
    public function getDataByRuteId(Request $request)
    {
        ...
        return view('RuteId', compact('data', 'salesman', 'rute_id', 'rute'));
    ...
    public function getOrder(Request $request)
    {
        ...
        $data = Order::with('art.ar')->where('id_salesman', $id_salesman)->where('tgl_transaksi', $tgl_transaksi)->get();
